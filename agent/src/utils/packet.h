...
public:
	...
	ptr makeSharedInstance(int packetNumber, int timestamp, struct in_addr ip_src, struct in_addr ip_dst, u_char ip_protocol);
	ptr makeSharedInstance(int packetNumber, int timestamp, struct in_addr ip_src, struct in_addr ip_dst, u_char ip_protocol, u_short th_sport, u_short th_dport, int size_payload);
